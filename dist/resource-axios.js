...
var _requested = {"type":"range","registry":true,"raw":"axios@^0.18.0","name":"axios","escapedName":"axios","rawSpec":"^0.18.0","saveSpec":null,"fetchSpec":"^0.18.0"};
var _requiredBy = ["/"];
...
var resourceAxios = (path, actions) => {
  const resource = {
    get: id => axios$1.get(`${path}/${id}`),
    query: params => axios$1.get(path, { params }),
    save: data => axios$1.post(path, data),
    update: (id, data) => axios$1.put(`${path}/${id}`, data),
    delete: id => axios$1.delete(`${path}/${id}`),
  };
